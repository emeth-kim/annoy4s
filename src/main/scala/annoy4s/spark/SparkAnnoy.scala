...
import annoy4s.{AnnoySingletonLoader, Metric, Annoy}
...
//    */
//  def build(dataset: RDD[(Int, Array[Float])], rank: Int, numOfTrees: Int, metric: Metric = Angular, verbose: Boolean): AnnoySingletonLoader = {
...
//  }
//
//  def build(dataset: DataFrame, rank: Int, numOfTree: Int, metric: Metric = Angular, verbose: Boolean): AnnoySingletonLoader = {
